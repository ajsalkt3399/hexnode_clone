...
function News() {
    return (
        <div>
            <div className='fixer top-0 bg-[#2E72F6] text-[18px] py-4 flex items-center text-white mulishbold justify-center'>News </div>
            <div className='flex flex-col items-center justify-center h-[60vh]'>
                ...
                <h2>No News</h2>
                <span>News from the team will be shown here</span>
            </div>

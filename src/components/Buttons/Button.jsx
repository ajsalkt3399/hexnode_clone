...
const Button = ({ label, customStyle = '', onClick, loading = false }) => {
  return (
    <button
      className={` text-white mulishbold font-semibold py-2 px-3 rounded flex items-center justify-center transition ${customStyle}`}
      onClick={onClick}
    >
      {label}
      {loading && (
        <span className=" ml-[2px] overflow-hidden animate-spin flex justify-center items-center w-4 h-4">
          <svg
            stroke=""
            fill=""
            strokeWidth="0"
